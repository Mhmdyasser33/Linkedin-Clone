...
import { logOutFromFirebase} from './redux/actions';
const Header = (props) => {
  return (
    <Container>
    <Content>
      ...
      <Nav>
        <NavListWrap>
          ...
          <User>
            <a>
           {props.user && props.user.photoURL ? <img src={props.user.photoURL}/> :<img src='/public/images/user.svg'/>}
              <span>
                Me
...
const mapDispatchToProps = (dispatch) =>{
   return {
    logOut :() => dispatch(logOutFromFirebase())
   }
}
